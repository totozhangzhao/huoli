  ...
  <div class="wechat-login-area">
    <label for="">
      ...
      <div class="label-son-flex wechat-login-insert">
        <input name="phone" type="text" placeholder="请输入手机号" class="js-phone-num" data-check-method="checkPhoneNum">
      </div>
    ...
    <label for="">
      ...
      <div class="label-son-flex wechat-login-insert">
        <input name="code" type="text" placeholder="请输入验证码" class="js-captcha">
      </div>
    </label>
  </div>
