<div class="<%= orderDetail.needpay === 1 ? "pay-status-bar" : "pay-after-bar" %>">
  <div class="goods-detail clearfix">
    ...
    <div class="js-goods-price goods-charge-info-fa">
      <!-- <p class="js-goods-price goods-charge-info num-font"><span>100</span> 积分 + <span>100</span> 元</p> -->
      <% if ( orderDetail.points > 0 && orderDetail.money > 0 ) { %>
      <p class="js-goods-price goods-charge-info num-font"><span><%= orderDetail.points %></span>积分 + <span><%= orderDetail.money %></span>元</p>
      <% } else if ( orderDetail.points > 0 ) { %>
      <p class="js-goods-price goods-charge-info num-font"><span><%= orderDetail.points %></span>积分</p>
      <% } else if ( orderDetail.money > 0 ) { %>
      <p class="js-goods-price goods-charge-info num-font"><span><%= orderDetail.money %></span>元</p>
      <% } else { %>
